...
PGPASSWORD=$(aws secretsmanager get-secret-value --secret-id ${PGPASSWORD_SECRET_NAME} --query "SecretString" --output text)

echo "AWS_ACCOUNT_ID: ${AWS_ACCOUNT_ID}"
echo "AWS_REGION: ${AWS_REGION}"
echo "ECS_TASK_CPU: ${ECS_TASK_CPU}"
...
echo "S3_ARTIFACTS_KEY: ${S3_ARTIFACTS_KEY}"
